...
*This guide provides comprehensive user management capabilities for EntityDB v2.32.5. For additional security configuration, see [Security Configuration](./01-security-configuration.md).*